...
def main():
    ...
    parser.add_argument('--experiment_name', default='fraud_iter_learning')
    ...
    with mlflow.start_run(experiment_id=exp.experiment_id):
        ...
        joblib.dump(model, f"models/fraud_model_A.joblib")
        joblib.dump(model, f"models/fraud_model_B.joblib")
        preprocessor.save("models/fraud_preprocessor.joblib")
